...
class CreateMLReader:
    ...
    def parse_json(self):
        ...
        print(f"[DEBUG] JSON file path: {self.json_path}")
        print(f"[DEBUG] JSON file content: {input_data}")

        # Returns a list
        output_list = json.loads(input_data)

        print(f"[DEBUG] Parsed output_list type: {type(output_list)}")
        print(f"[DEBUG] Parsed output_list: {output_list}")
